...
long_description = """MASTDataDelivery
==========
...
setup(
    ...
    name='MASTDataDelivery',  # Required
    ...
    version='1.1.3-oliver',  # Required

    # This is a one-line description or tagline of what your project does. This
    # corresponds to the "Summary" metadata field:
    # https://packaging.python.org/specifications/core-metadata/#summary
    description='MAST Data Delivery library',  # Required
    ...
    # above.
    author_email='fleming@stsci.edu',  # Optional
    ...
    classifiers=[  # Optional
        ...
        'Topic :: Software Development :: Astronomy Analysis Tools',
